...
{pkgs, ...}: let
  ...
  preferWheelOverrides = {
    # Windows-only package; wheel avoids any build issues on Linux.
    ansicon = {};
    anybadge = {};
    ...
    pydriller = {};
    # lib2to3 removed in Python 3.13; wheel avoids the sdist build.
    yapf = {};
    # C extensions — wheels are simpler than native builds.
    contourpy = {};
    kiwisolver = {};
    matplotlib = {};
    numpy = {};
