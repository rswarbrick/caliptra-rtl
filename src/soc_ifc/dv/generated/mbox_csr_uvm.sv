...
package mbox_csr_uvm;
    ...
    class mbox_csr__mbox_lock extends dv_base_reg;
        `uvm_object_utils(mbox_csr__mbox_lock)
    ...
    class mbox_csr__mbox_user extends dv_base_reg;
        `uvm_object_utils(mbox_csr__mbox_user)
        protected uvm_reg_data_t m_current;
        protected uvm_reg_data_t m_data;
        protected bit            m_is_read;
    ...
    class mbox_csr__mbox_cmd extends dv_base_reg;
        `uvm_object_utils(mbox_csr__mbox_cmd)
        protected uvm_reg_data_t m_current;
        protected uvm_reg_data_t m_data;
        protected bit            m_is_read;
        ...
        rand dv_base_reg_field command;
        ...
        virtual function void build();
            this.command = dv_base_reg_field::type_id::create("command");
    ...
    class mbox_csr__mbox_dlen extends dv_base_reg;
        `uvm_object_utils(mbox_csr__mbox_dlen)
        protected uvm_reg_data_t m_current;
        protected uvm_reg_data_t m_data;
        protected bit            m_is_read;
    ...
    class mbox_csr__mbox_datain extends dv_base_reg;
        `uvm_object_utils(mbox_csr__mbox_datain)
        protected uvm_reg_data_t m_current;
        protected uvm_reg_data_t m_data;
        protected bit            m_is_read;
    ...
    class mbox_csr__mbox_dataout extends dv_base_reg;
        `uvm_object_utils(mbox_csr__mbox_dataout)
        protected uvm_reg_data_t m_current;
        protected uvm_reg_data_t m_data;
        protected bit            m_is_read;
        ...
        rand dv_base_reg_field dataout;
        ...
        virtual function void build();
            this.dataout = dv_base_reg_field::type_id::create("dataout");
    ...
    class mbox_csr__mbox_execute extends dv_base_reg;
        `uvm_object_utils(mbox_csr__mbox_execute)
        protected uvm_reg_data_t m_current;
        protected uvm_reg_data_t m_data;
        protected bit            m_is_read;
    ...
    class mbox_csr__mbox_status_ecc_double_error_38cec4b0_ecc_single_error_9c62b760 extends dv_base_reg;
        `uvm_object_utils(mbox_csr__mbox_status_ecc_double_error_38cec4b0_ecc_single_error_9c62b760)
        protected uvm_reg_data_t m_current;
        protected uvm_reg_data_t m_data;
        protected bit            m_is_read;
        ...
        rand dv_base_reg_field ecc_single_error;
        rand dv_base_reg_field ecc_double_error;
        rand dv_base_reg_field mbox_fsm_ps;
        rand dv_base_reg_field soc_has_lock;
        rand dv_base_reg_field mbox_rdptr;
        rand dv_base_reg_field tap_has_lock;
        ...
        virtual function void build();
            ...
            this.ecc_single_error = dv_base_reg_field::type_id::create("ecc_single_error");
            this.ecc_single_error.configure(this, 1, 4, "RO", 1, 'h0, 1, 1, 0);
            this.ecc_double_error = dv_base_reg_field::type_id::create("ecc_double_error");
            this.ecc_double_error.configure(this, 1, 5, "RO", 1, 'h0, 1, 1, 0);
            this.mbox_fsm_ps = dv_base_reg_field::type_id::create("mbox_fsm_ps");
            ...
            this.mbox_rdptr = dv_base_reg_field::type_id::create("mbox_rdptr");
            this.mbox_rdptr.configure(this, 16, 10, "RO", 1, 'h0, 1, 1, 0);
            this.tap_has_lock = dv_base_reg_field::type_id::create("tap_has_lock");
    ...
    class mbox_csr__mbox_unlock extends dv_base_reg;
        `uvm_object_utils(mbox_csr__mbox_unlock)
        protected uvm_reg_data_t m_current;
        protected uvm_reg_data_t m_data;
        protected bit            m_is_read;
        ...
        virtual function void build();
            this.unlock = dv_base_reg_field::type_id::create("unlock");
    ...
    class mbox_csr__tap_mode extends dv_base_reg;
        `uvm_object_utils(mbox_csr__tap_mode)
        protected uvm_reg_data_t m_current;
        protected uvm_reg_data_t m_data;
        protected bit            m_is_read;
        ...
        rand dv_base_reg_field enabled;
        ...
        virtual function void build();
            this.enabled = dv_base_reg_field::type_id::create("enabled");
    ...
    // addrmap - mbox_csr
    class mbox_csr extends dv_base_reg_block;
        `uvm_object_utils(mbox_csr)
