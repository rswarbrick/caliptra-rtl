...
(
  input logic                     clk_i,
  input logic                     rst_ni,
  caliptra_prim_mubi_pkg::mubi8_t otp_en_entropy_src_fw_read_i,
  caliptra_prim_mubi_pkg::mubi8_t otp_en_entropy_src_fw_over_i
);
  ...
  import caliptra_prim_mubi_pkg::MuBi4True, caliptra_prim_mubi_pkg::MuBi4False;
  import caliptra_prim_mubi_pkg::mubi8_t;
  import caliptra_prim_mubi_pkg::MuBi8True, caliptra_prim_mubi_pkg::MuBi8False;
