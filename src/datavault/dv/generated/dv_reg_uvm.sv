...
package dv_reg_uvm;
    ...
    class dv_reg__StickyDataVaultCtrl extends dv_base_reg;
        `uvm_object_utils(dv_reg__StickyDataVaultCtrl)
        ...
        rand dv_base_reg_field lock_entry;
        ...
        virtual function void build();
            this.lock_entry = dv_base_reg_field::type_id::create("lock_entry");
    ...
    class dv_reg__StickyDataVaultReg extends dv_base_reg;
        `uvm_object_utils(dv_reg__StickyDataVaultReg)
        protected uvm_reg_data_t m_current;
        protected uvm_reg_data_t m_data;
        protected bit            m_is_read;
    ...
    class dv_reg__DataVaultCtrl extends dv_base_reg;
        `uvm_object_utils(dv_reg__DataVaultCtrl)
        protected uvm_reg_data_t m_current;
        protected uvm_reg_data_t m_data;
        protected bit            m_is_read;
    ...
    class dv_reg__DataVaultReg extends dv_base_reg;
        `uvm_object_utils(dv_reg__DataVaultReg)
        protected uvm_reg_data_t m_current;
        protected uvm_reg_data_t m_data;
        protected bit            m_is_read;
    ...
    class dv_reg__LockableScratchRegCtrl extends dv_base_reg;
        `uvm_object_utils(dv_reg__LockableScratchRegCtrl)
        protected uvm_reg_data_t m_current;
        protected uvm_reg_data_t m_data;
        protected bit            m_is_read;
    ...
    class dv_reg__LockableScratchReg extends dv_base_reg;
        `uvm_object_utils(dv_reg__LockableScratchReg)
        protected uvm_reg_data_t m_current;
        protected uvm_reg_data_t m_data;
        protected bit            m_is_read;
    ...
    class dv_reg__NonStickyGenericScratchReg extends dv_base_reg;
        `uvm_object_utils(dv_reg__NonStickyGenericScratchReg)
        protected uvm_reg_data_t m_current;
        protected uvm_reg_data_t m_data;
        protected bit            m_is_read;
    ...
    class dv_reg__StickyLockableScratchRegCtrl extends dv_base_reg;
        `uvm_object_utils(dv_reg__StickyLockableScratchRegCtrl)
        protected uvm_reg_data_t m_current;
        protected uvm_reg_data_t m_data;
        protected bit            m_is_read;
    ...
    class dv_reg__StickyLockableScratchReg extends dv_base_reg;
        `uvm_object_utils(dv_reg__StickyLockableScratchReg)
        protected uvm_reg_data_t m_current;
        protected uvm_reg_data_t m_data;
        protected bit            m_is_read;
    ...
    // addrmap - dv_reg
    class dv_reg extends dv_base_reg_block;
        `uvm_object_utils(dv_reg)
        ...
        virtual function void build();
            ...
            foreach(this.StickyDataVaultCtrl[i0]) begin
                this.StickyDataVaultCtrl[i0] = dv_reg__StickyDataVaultCtrl::type_id::create($sformatf("StickyDataVaultCtrl[%0d]", i0));
            ...
            foreach(this.STICKY_DATA_VAULT_ENTRY[i0, i1]) begin
                this.STICKY_DATA_VAULT_ENTRY[i0][i1] = dv_reg__StickyDataVaultReg::type_id::create($sformatf("STICKY_DATA_VAULT_ENTRY[%0d][%0d]", i0, i1));
            ...
            foreach(this.DataVaultCtrl[i0]) begin
                this.DataVaultCtrl[i0] = dv_reg__DataVaultCtrl::type_id::create($sformatf("DataVaultCtrl[%0d]", i0));
            ...
            foreach(this.DATA_VAULT_ENTRY[i0, i1]) begin
                this.DATA_VAULT_ENTRY[i0][i1] = dv_reg__DataVaultReg::type_id::create($sformatf("DATA_VAULT_ENTRY[%0d][%0d]", i0, i1));
            ...
            foreach(this.LockableScratchRegCtrl[i0]) begin
                this.LockableScratchRegCtrl[i0] = dv_reg__LockableScratchRegCtrl::type_id::create($sformatf("LockableScratchRegCtrl[%0d]", i0));
            ...
            foreach(this.LockableScratchReg[i0]) begin
                this.LockableScratchReg[i0] = dv_reg__LockableScratchReg::type_id::create($sformatf("LockableScratchReg[%0d]", i0));
            ...
            foreach(this.NonStickyGenericScratchReg[i0]) begin
                this.NonStickyGenericScratchReg[i0] = dv_reg__NonStickyGenericScratchReg::type_id::create($sformatf("NonStickyGenericScratchReg[%0d]", i0));
            ...
            foreach(this.StickyLockableScratchRegCtrl[i0]) begin
                this.StickyLockableScratchRegCtrl[i0] = dv_reg__StickyLockableScratchRegCtrl::type_id::create($sformatf("StickyLockableScratchRegCtrl[%0d]", i0));
            ...
            foreach(this.StickyLockableScratchReg[i0]) begin
                this.StickyLockableScratchReg[i0] = dv_reg__StickyLockableScratchReg::type_id::create($sformatf("StickyLockableScratchReg[%0d]", i0));
