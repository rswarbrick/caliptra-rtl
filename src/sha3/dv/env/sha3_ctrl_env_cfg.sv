...
class sha3_ctrl_env_cfg extends dv_base_env_cfg #(.RAL_T(sha3_ctrl_dv_reg));
  ...
  virtual function void initialize();
    ...
    // Add an extra constraint to MSG_FIFO, causing it to be write-only. This can't come from the
    // autogenerated code from the RDL description because that access mode isn't really supported
    // by uvm_mem itself.
    ral.kmac_core.MSG_FIFO.m_mem.set_access("WO");
