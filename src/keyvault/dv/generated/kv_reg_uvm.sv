...
package kv_reg_uvm;
    ...
    // reg - kv_reg::kvCtrl
    class kv_reg__kvCtrl extends dv_base_reg;
        `uvm_object_utils(kv_reg__kvCtrl)
        ...
        rand dv_base_reg_field lock_wr;
        rand dv_base_reg_field lock_use;
        rand dv_base_reg_field clear;
        rand dv_base_reg_field rsvd0;
        rand dv_base_reg_field rsvd1;
        rand dv_base_reg_field dest_valid;
        rand dv_base_reg_field last_dword;
        ...
        virtual function void build();
            this.lock_wr = dv_base_reg_field::type_id::create("lock_wr");
            this.lock_wr.configure(this, 1, 0, "RW", 1, 'h0, 1, 1, 0);
            this.lock_use = dv_base_reg_field::type_id::create("lock_use");
            ...
            this.dest_valid = dv_base_reg_field::type_id::create("dest_valid");
            this.dest_valid.configure(this, 9, 9, "RO", 1, 'h0, 1, 1, 0);
            this.last_dword = dv_base_reg_field::type_id::create("last_dword");
    ...
    // reg - kv_reg::keyReg
    class kv_reg__keyReg extends dv_base_reg;
        `uvm_object_utils(kv_reg__keyReg)
        protected uvm_reg_data_t m_current;
        protected uvm_reg_data_t m_data;
        protected bit            m_is_read;
    ...
    class kv_reg__CLEAR_SECRETS extends dv_base_reg;
        `uvm_object_utils(kv_reg__CLEAR_SECRETS)
        protected uvm_reg_data_t m_current;
        protected uvm_reg_data_t m_data;
        protected bit            m_is_read;
        ...
        rand dv_base_reg_field wr_debug_values;
        rand dv_base_reg_field sel_debug_value;
        ...
        virtual function void build();
            this.wr_debug_values = dv_base_reg_field::type_id::create("wr_debug_values");
            this.wr_debug_values.configure(this, 1, 0, "RW", 1, 'h0, 1, 1, 0);
            this.sel_debug_value = dv_base_reg_field::type_id::create("sel_debug_value");
    ...
    // addrmap - kv_reg
    class kv_reg extends dv_base_reg_block;
        `uvm_object_utils(kv_reg)
        ...
        virtual function void build();
            ...
            foreach(this.KEY_CTRL[i0]) begin
                this.KEY_CTRL[i0] = kv_reg__kvCtrl::type_id::create($sformatf("KEY_CTRL[%0d]", i0));
            ...
            foreach(this.KEY_ENTRY[i0, i1]) begin
                this.KEY_ENTRY[i0][i1] = kv_reg__keyReg::type_id::create($sformatf("KEY_ENTRY[%0d][%0d]", i0, i1));
            ...
            this.CLEAR_SECRETS = kv_reg__CLEAR_SECRETS::type_id::create("CLEAR_SECRETS");
